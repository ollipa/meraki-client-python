...
class Organizations:
    ...
    def create_organization_inventory_onboarding_cloud_monitoring_export_event(
        ...
        *,
    ...
    ) -> CreateOrganizationInventoryOnboardingCloudMonitoringExportEventResponse | None:
        ...
        return self._session.post(
            ...
            path=path,
            json=payload,
            response_schema=CreateOrganizationInventoryOnboardingCloudMonitoringExportEventResponse,
        )
    ...
    def get_organization_openapi_spec(
    ...
    ) -> GetOrganizationOpenapiSpecResponse | None:
        ...
        return self._session.get(
            ...
            path=path,
            params=params,
            response_schema=GetOrganizationOpenapiSpecResponse,
        )
