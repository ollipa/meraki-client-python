...
class BindAdministeredLicensingSubscriptionSubscriptionResponse(_BaseSchema):
    ...
    @field_validator("networks", "errors", "insufficient_entitlements", mode="before")
    @classmethod
...
class ClaimAdministeredLicensingSubscriptionSubscriptionsResponse(_BaseSchema):
    ...
    @field_validator("product_types", "entitlements", mode="before")
    @classmethod
    def coerce_null_lists(cls, value: Any) -> Any:
        """Convert null array values from the API to empty lists."""
        return [] if value is None else value
...
class GetOrganizationLicensingCotermLicensesResponseItem(_BaseSchema):
    ...
    @field_validator("editions", "counts", mode="before")
    @classmethod
    def coerce_null_lists(cls, value: Any) -> Any:
        """Convert null array values from the API to empty lists."""
        return [] if value is None else value
...
class LicensingViolations(_BaseSchema):
    ...
    @field_validator("by_product_class", mode="before")
    @classmethod
    def coerce_null_lists(cls, value: Any) -> Any:
        """Convert null array values from the API to empty lists."""
        return [] if value is None else value
...
class MoveOrganizationLicensingCotermLicensesResponse(_BaseSchema):
    ...
    @field_validator("remainder_licenses", "moved_licenses", mode="before")
    @classmethod
    def coerce_null_lists(cls, value: Any) -> Any:
        """Convert null array values from the API to empty lists."""
        return [] if value is None else value
