...
class Wireless:
    ...
    def get_network_wireless_alternate_management_interface(self, network_id: str) -> DictResponse:
    ...
    def get_network_wireless_devices_latency_stats(
        ...
        *,
        ...
        vlan: int | None = None,
        fields: str | None = None,
    ) -> PaginatedResponse[GetDeviceWirelessLatencyStatsResponse]:
    ...
    def get_network_wireless_ssids(
        self, network_id: str
    ) -> PaginatedResponse[NetworkWirelessSsidResponse]:
