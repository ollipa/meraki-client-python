...
class Organizations:
    ...
    def get_organization_devices_syslog_servers_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> PaginatedResponse[GetOrganizationDevicesSyslogServersByNetworkResponseItemsItem]:
    ...
    def get_organization_devices_syslog_servers_roles_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> PaginatedResponse[GetOrganizationDevicesSyslogServersRolesByNetworkResponseItemsItem]:
    ...
    def get_organization_inventory_devices_eox_overview(
        self, organization_id: str
    ) -> GetOrganizationInventoryDevicesEoxOverviewResponse:
    ...
    ) -> PaginatedResponse[GetOrganizationWebhooksAlertTypesResponseItem]:
