...
class Devices:
    ...
    def get_device(self, serial: str) -> DeviceResponse:
    ...
    def get_device_cellular_sims(self, serial: str) -> DeviceCellularSimsResponse:
    ...
    def create_device_live_tools_ports_cycle(
        self,
        *,
        serial: str,
        ports: list[str],
    ...
    def get_device_live_tools_ports_cycle(
        self, *, serial: str, id: str
    ) -> GetDeviceLiveToolsPortsCycleResponse:
    ...
    def get_device_live_tools_ports_status(
    ...
    def get_device_live_tools_power_usage(
        self, *, serial: str, job_id: str
    ) -> GetDeviceLiveToolsPowerUsageResponse:
    ...
    def get_device_live_tools_routing_table_lookup(
        self, *, serial: str, id: str
    ) -> GetDeviceLiveToolsRoutingTableLookupResponse:
    ...
    def get_device_live_tools_routing_table_summary(
        self, *, serial: str, id: str
    ) -> GetDeviceLiveToolsRoutingTableSummaryResponse:
    ...
    def get_device_management_interface(self, serial: str) -> DeviceManagementInterfaceResponse:
