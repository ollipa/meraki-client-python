...
class Switch:
    ...
    async def get_network_switch_mtu(
        self, *, network_id: str
    ) -> GetNetworkSwitchMtuResponse | None:
    ...
    async def get_network_switch_stp(
        self, *, network_id: str
    ) -> GetNetworkSwitchStpResponse | None:
