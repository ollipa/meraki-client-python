...
class Appliance:
    ...
    async def create_device_appliance_interfaces_ports_update(
        self,
        serial: str,
        *,
    ...
    def get_device_appliance_prefixes_delegated(
        self, serial: str
    ) -> AsyncPaginatedResponse[GetDeviceAppliancePrefixesDelegatedResponseItem]:
    ...
    def get_device_appliance_prefixes_delegated_vlan_assignments(
        self, serial: str
    ) -> AsyncPaginatedResponse[GetDeviceAppliancePrefixesDelegatedVlanAssignmentsResponseItem]:
    ...
    async def update_network_appliance_devices_redundancy(
        self,
        *,
        network_id: str,
        enabled: bool,
    ...
    async def create_network_appliance_devices_redundancy_swap(
        self, network_id: str
    ) -> UpdateNetworkApplianceDevicesRedundancyResponse:
    ...
    def get_network_appliance_firewall_firewalled_services(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkApplianceFirewallFirewalledServiceResponse]:
    ...
    async def create_network_appliance_interfaces_l3(
        self,
        *,
        network_id: str,
    ...
    async def update_network_appliance_interfaces_l3(
        self,
        *,
        network_id: str,
        interface_id: str,
    ...
    async def delete_network_appliance_interfaces_l3(
    ...
    def get_network_appliance_ports(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkAppliancePortResponse]:
    ...
    def get_network_appliance_prefixes_delegated_statics(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkAppliancePrefixesDelegatedStaticResponse]:
    ...
    def get_network_appliance_ssids(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkApplianceSsidResponse]:
    ...
    def get_network_appliance_static_routes(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkApplianceStaticRouteResponse]:
    ...
    def get_network_appliance_traffic_shaping_custom_performance_classes(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkApplianceTrafficShapingCustomPerformanceClassResponse]:
    ...
    async def connect_network_appliance_umbrella_account(
    ...
    async def disconnect_network_appliance_umbrella_account(self, network_id: str) -> None:
    ...
    async def exclusions_network_appliance_umbrella_domains(
    ...
    async def add_network_appliance_umbrella_policies(
    ...
    async def remove_network_appliance_umbrella_policies(
    ...
    async def protection_network_appliance_umbrella(
    ...
    async def update_network_appliance_uplinks_nat(
    ...
    def get_organization_appliance_devices_interfaces_l3(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> AsyncPaginatedResponse[GetOrganizationApplianceDevicesInterfacesL3ResponseItemsItem]:
    ...
    def get_organization_appliance_devices_redundancy_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> AsyncPaginatedResponse[UpdateNetworkApplianceDevicesRedundancyResponseDesignationsItem]:
        """Return MX warm spare settings.
    ...
    ) -> AsyncPaginatedResponse[OrganizationApplianceDnsLocalProfileResponse]:
    ...
    def get_organization_appliance_dns_local_records(
        self, organization_id: str, *, profile_ids: list[str] | None = None
    ) -> AsyncPaginatedResponse[UpdateOrganizationApplianceDnsLocalRecordResponse]:
    ...
    def get_organization_appliance_dns_split_profiles(
        self, organization_id: str, *, profile_ids: list[str] | None = None
    ) -> AsyncPaginatedResponse[OrganizationApplianceDnsSplitProfileResponse]:
    ...
    def get_organization_appliance_firewall_multicast_forwarding_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> AsyncPaginatedResponse[UpdateNetworkApplianceFirewallMulticastForwardingResponse]:
    ...
    async def get_organization_appliance_routing_vrfs_settings(
    ...
    async def update_organization_appliance_routing_vrfs_settings(
    ...
    def get_organization_appliance_traffic_shaping_vpn_exclusions_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> AsyncPaginatedResponse[UpdateNetworkApplianceTrafficShapingVpnExclusionsResponse]:
    ...
    def get_organization_appliance_uplinks_nat_by_network(
        ...
        *,
        ...
        total_pages: int | Literal["all"] = "all",
        direction: Literal["prev", "next"] = "next",
    ) -> AsyncPaginatedResponse[GetOrganizationApplianceUplinksNatByNetworkResponseItem]:
    ...
    def get_organization_appliance_vpn_site_to_site_ipsec_peers_slas(
        self, organization_id: str
    ) -> AsyncPaginatedResponse[OrganizationApplianceVpnSiteToSiteIpsecPeersSlasResponseItemsItem]:
    ...
    async def assign_organization_policies_global_group_policies_appliance_vlans(
        self,
        *,
        organization_id: str,
    ...
    async def remove_organization_policies_global_group_policies_appliance_vlans(
        self,
        *,
        organization_id: str,
