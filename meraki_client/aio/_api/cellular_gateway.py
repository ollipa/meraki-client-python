...
class CellularGateway:
    ...
    ) -> AsyncPaginatedResponse[UpdateOrganizationCellularGatewayEsimsInventoryResponse]:
    ...
    ) -> AsyncPaginatedResponse[OrganizationCellularGatewayEsimsServiceProvidersAccountResponse]:
