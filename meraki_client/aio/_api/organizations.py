...
class Organizations:
    ...
    async def get_organization_saml(self, organization_id: str) -> GetOrganizationSamlResponse:
    ...
    async def get_organization_snmp(self, organization_id: str) -> GetOrganizationSnmpResponse:
