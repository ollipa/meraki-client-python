...
class Sensor:
    ...
    ) -> AsyncPaginatedResponse[DeviceSensorCommandResponse]:
        ...
        *,
        ...
        Args:
            ...
            interval: The time interval in seconds for returned data. The valid intervals are: 900,
                3600, 86400, 604800, 2629746. The default is 604800. Interval is
    ...
    def get_network_sensor_alerts_profiles(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkSensorAlertsProfileResponse]:
    ...
    def get_network_sensor_mqtt_brokers(
        self, network_id: str
    ) -> AsyncPaginatedResponse[NetworkSensorMqttBrokerResponse]:
        ...
        *,
        ...
        Args:
            ...
            t0: The beginning of the timespan for the data. The maximum lookback period is 365 days,
                5 hours, 49 minutes, and 12 seconds from today.
