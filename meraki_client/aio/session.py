...
from meraki_client.common import BaseURL, format_user_agent_caller, handle_3xx
from meraki_client.exceptions import MerakiConnectionError, MerakiHTTPError, raise_http_error
...
class Session:
    ...
    def get_pages(
        ...
        *,
        ...
        async def fetch_pages() -> AsyncIterator[Any]:
            current_page = 1
