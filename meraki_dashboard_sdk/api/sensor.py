...
class Sensor:
    ...
    def get_device_sensor_commands(self, serial: str, total_pages=1, direction="next", **kwargs):
    ...
    def get_device_sensor_command(self, serial: str, commandId: str):
    ...
    def get_device_sensor_relationships(self, serial: str):
    ...
    def get_network_sensor_alerts_current_overview_by_metric(self, networkId: str):
    ...
    def get_network_sensor_alerts_overview_by_metric(self, networkId: str, **kwargs):
    ...
    def get_network_sensor_alerts_profiles(self, networkId: str):
    ...
    def get_network_sensor_alerts_profile(self, networkId: str, id: str):
    ...
    def get_network_sensor_mqtt_brokers(self, networkId: str):
    ...
    def get_network_sensor_mqtt_broker(self, networkId: str, mqttBrokerId: str):
    ...
    def get_network_sensor_relationships(self, networkId: str):
