...
class Administered:
    ...
    def get_administered_identities_me(self):
    ...
    def get_administered_identities_me_api_keys(self):
    ...
    def generate_administered_identities_me_api_keys(self):
    ...
    def revoke_administered_identities_me_api_keys(self, suffix: str):
