...
class AsyncDevices:
    ...
    def getDeviceClients(self, serial: str, **kwargs):
        ...
        metadata = {"tags": ["devices", "monitor", "clients"], "operation": "getDeviceClients"}
        serial = urllib.parse.quote(str(serial), safe="")
    ...
    def getDeviceLiveToolsPing(self, serial: str, id: str):
        ...
        metadata = {"tags": ["devices", "liveTools", "ping"], "operation": "getDeviceLiveToolsPing"}
        serial = urllib.parse.quote(str(serial), safe="")
        id = urllib.parse.quote(str(id), safe="")
    ...
    def getDeviceLldpCdp(self, serial: str):
        ...
        metadata = {"tags": ["devices", "monitor", "lldpCdp"], "operation": "getDeviceLldpCdp"}
        serial = urllib.parse.quote(str(serial), safe="")
